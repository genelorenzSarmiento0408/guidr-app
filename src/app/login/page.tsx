...
export default function Login() {
  ...
  return (
    <div className="bg-[#030403] bg-[radial-gradient(ellipse_80%_55%_at_50%_0%,_rgba(23,55,21,0.6),_transparent_100%)]">
      <div className="bg-[url('/registration-pattern.png')] bg-no-repeat bg-center bg-cover box-border content-stretch flex min-h-screen items-center justify-between gap-20 p-20 relative w-full overflow-hidden">
        {/* Left Branding Panel */}
        <div className="content-stretch flex flex-col h-full items-start justify-between relative shrink-0 w-[425px]">
          <div className="content-stretch flex flex-col gap-20 items-start leading-[normal] relative shrink-0 w-full mb-10">
            ...
            <p className="font-sans min-w-full relative shrink-0 text-[#f9f9f9] text-[48px] font-normal leading-tight">
          ...
          <div className="relative rounded-[10px] shrink-0 w-full">
            ...
            <div className="flex flex-row items-center justify-center size-full">
              <div className="border-[#0D420A94] box-border content-stretch flex gap-2.5 items-center justify-center p-[22px] relative w-full">
                <p className=" basis-0 font-sans grow leading-[30px] min-h-px min-w-px relative shrink-0 text-[#f9f9f9] text-[18px] font-normal">
        ...
        <div className="bg-[#f9f9f9] box-border content-stretch flex flex-col gap-[30px] items-start p-[50px] relative rounded-[10px] shrink-0 w-[619px]">
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0">
            <p className="font-sans leading-[normal] relative shrink-0 text-[#0d110d] text-[34px] text-nowrap whitespace-pre font-normal">
              Welcome Back
            </p>
            <div className="content-stretch flex font-sans gap-4 items-center leading-[25px] relative shrink-0 text-[16px] text-nowrap tracking-[0.32px] whitespace-pre font-normal">
          ...
          {error && (
            <div className="w-full p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg text-sm font-sans">
              {error}
            </div>
          )}
          ...
          >
            <div className="content-stretch flex flex-col gap-6 items-start relative shrink-0 w-full">
              <div className="relative rounded-[999px] shrink-0 w-full">
                ...
                <input
                  ...
                  className="w-full bg-transparent outline-none px-6 py-4 font-sans leading-[25px] text-[14px] text-[#0d110d] tracking-[0.56px] placeholder:text-[#6c6c6c] focus:ring-2 focus:ring-[#228c1d] rounded-[999px]"
                />
              </div>
            ...
            <div className="content-stretch flex flex-col gap-[22px] items-start relative shrink-0 w-full mt-4">
              ...
              >
                ...
                <div className="flex flex-row items-center justify-center size-full relative z-10">
                  <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[30px] py-[14px] relative w-full">
                    <p className="font-sans leading-[25px] relative shrink-0 text-[#0d110d] group-hover:text-white text-[14px] font-bold text-nowrap tracking-[0.56px] transition-colors">
              ...
              <div className="flex justify-center w-full mb-1">
                <span className="text-[#6c6c6c] text-sm font-sans">OR</span>
              </div>
              ...
              >
                ...
                <p className="font-sans leading-[25px] text-[#6c6c6c] text-[14px] font-bold text-nowrap tracking-[0.56px]">
                  Sign-in with Google
                </p>
              </button>
            </div>
