...
export default function RegisterClient() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030403] bg-[radial-gradient(ellipse_80%_55%_at_50%_0%,rgba(23,55,21,0.6),transparent_100%)]">
        ...
        <div className="w-full flex items-center justify-between max-w-7xl gap-12 px-8">
          ...
          <div className="hidden lg:flex flex-1 flex-col justify-between text-guidr-light min-h-[600px]">
            <div>
              ...
              <p className="text-4xl  mb-2">Guided by purpose.</p>
              <p className="text-4xl ">Driven by people.</p>
            </div>
            <div className="p-6 border border-guidr-light/30 rounded-3xl max-w-md">
              <p className="text-lg">
          ...
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
            <div className="mb-6">
              <h2 className="text-3xl text-guidr-dark mb-2">Get Started</h2>
            ...
            {/* Role Selection Tabs */}
            <div className="mb-6">
              <p className="text-sm text-[#228C1D] mb-3">
              ...
              <div className="flex gap-2 border-b border-gray-200">
                <button
                  ...
                  style={{
                    ...
                    borderColor:
                      role === "organization" ? "#228C1D" : undefined,
                  }}
                >
                  Organization
                </button>
            ...
            {error && (
              <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-3xl">
              ...
              <form onSubmit={handleOrganizationSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    className="col-span-2 w-full px-4 py-3 border border-gray-300 rounded-3xl focus:outline-none focus:ring-2 focus:ring-guidr-green focus:border-transparent"
                    disabled={loading}
                  />
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-3xl focus:outline-none focus:ring-2 focus:ring-guidr-green focus:border-transparent"
                    disabled={loading}
                  />
                ...
                <button
                  ...
                  className="w-full py-3 rounded-3xl font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    backgroundColor:
                      loading ||
                      !orgForm.organizationName.trim() ||
              ...
              <form onSubmit={handleMentorSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    className="px-4 py-3 border border-gray-300 rounded-3xl focus:outline-none focus:ring-2 focus:ring-guidr-green focus:border-transparent"
                    disabled={loading}
                  />
                  <input
                    type="text"
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-3 rounded-3xl font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
