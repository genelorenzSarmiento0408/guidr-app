...
export default function ProfileSaveModal({ isOpen, onClose }: ProfileSaveModalProps) {
  ...
  return (
    <Modal
      ...
      className="max-w-md w-full mx-4 md:mx-auto mt-20 bg-white rounded-lg shadow-xl p-6 relative"
